...
(function($, Drupal) {
  ...
  /**
   * Openy Focal Point preview.
   */
  Drupal.behaviors.openyFocalPointPreview = {
    attach: function(context, settings) {
      /*var $focalPointDerivativePreviews = $(".openy-focal-point-derivative-preview");

      var $focalPointImagePreview = $("#openy-focal-point-preview-image");
      var $focalPointImagePreviewLabel = $("#openy-focal-point-preview-label");
      ...
      $focalPointDerivativePreviews.each(function () {
        $(this).click(function(event) {
          ...
          $(".openy-focal-point-derivative-preview.active").each(function () {
          ...
          $(".openy-focal-point-derivative-preview").removeClass('active');
          var $this = $(this);
